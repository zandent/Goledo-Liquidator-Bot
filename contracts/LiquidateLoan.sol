...
contract LiquidateLoan is FlashLoanReceiverBase, Ownable {
    ...
    ISwappiRouter02 uniswapV2Router;
    ...
    constructor(ILendingPoolAddressesProvider _addressProvider, ISwappiRouter02 _uniswapV2Router) FlashLoanReceiverBase(_addressProvider) public {
        provider = _addressProvider;
        lendingPoolAddr = provider.getLendingPool();

        // instantiate UniswapV2 Router02
        uniswapV2Router = ISwappiRouter02(address(_uniswapV2Router));
